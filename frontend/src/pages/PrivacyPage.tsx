  ...
  return (
    <div className="px-12 py-8 max-w-3xl mx-auto">
      ...
      <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
        ...
        <h2 className="text-lg font-semibold text-black mt-6">1. Information We Collect</h2>
        ...
        <h2 className="text-lg font-semibold text-black mt-6">2. How We Use Your Information</h2>
        ...
        <h2 className="text-lg font-semibold text-black mt-6">3. Data Sharing</h2>
        ...
        <h2 className="text-lg font-semibold text-black mt-6">4. Data Security</h2>
        ...
        <h2 className="text-lg font-semibold text-black mt-6">5. Your Rights</h2>
        ...
        <h2 className="text-lg font-semibold text-black mt-6">6. Contact</h2>
        <p className="pl-4">For privacy-related inquiries, reach out to <a href="mailto:sospeterkinyanjui57@gmail.com" className="text-green-700 hover:text-green-800">sospeterkinyanjui57@gmail.com</a>.</p>
      </div>
    </div>
    </div>
  )
