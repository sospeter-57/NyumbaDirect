...
export default function TermsPage() {
  return (
    <div className="px-12 py-8 max-w-3xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-black dark:text-white mb-6 text-center">Terms of Service</h1>

      <div className="space-y-4 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
        <p><strong className="text-black dark:text-white">Last updated:</strong> July 2026</p>

        <h2 className="text-lg font-semibold text-black dark:text-white mt-6">1. Acceptance of Terms</h2>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6">2. User Responsibilities</h2>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6">3. Tenant Terms</h2>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6">4. Landlord Terms</h2>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6">5. Payments</h2>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6">6. Limitation of Liability</h2>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6">7. Changes to Terms</h2>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6">8. Contact</h2>
        <p className="pl-4">For questions about these terms, contact <a href="mailto:sospeterkinyanjui57@gmail.com" className="text-green-700 dark:text-green-400 hover:text-green-800">sospeterkinyanjui57@gmail.com</a>.</p>
      </div>
    </div>
    </div>
  )
